...
| `--pos` `x,y` | ([Preview](https://aka.ms/terminal-preview)) Launches the terminal at the specified x and y coordinate on the screen. |
| `--size` `c,r` | ([Preview](https://aka.ms/terminal-preview)) Launches the terminal with the specified number of columns and rows. |
