...
> [!IMPORTANT]
> When Mica is enabled in the [theme settings](./themes#mica), Mica will appear underneath the Terminal contents when the `opacity` of the Terminal is set to a value <100.
